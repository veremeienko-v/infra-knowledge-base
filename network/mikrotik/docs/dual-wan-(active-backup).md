...
Скопіювати скрипт з файлу dhcp_recursive.rsc, до DHCP Client (наприклад ISP1) в мікротіку, необхідно вимкнути маршрути за замовчуванням. Скрипт автоматично додає та видаляє необхідні маршрути та правило маскарадинга.
