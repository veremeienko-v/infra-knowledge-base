...
Скопіювати скрипт з файлу dhcp_recursive-ISP-1(ISP-2, ISP-3).rsc, до DHCP Clients в мікротіку, необхідно вимкнути маршрути за замовчуванням. Скрипт автоматично додає та видаляє необхідні маршрути та правило маскарадинга.
