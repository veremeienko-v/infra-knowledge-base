...
Скопіювати скрипти [ISP1](../scripts/dhcp-recursive-isp-1) [ISP2](../scripts/dhcp-recursive-isp-1) [ISP3](../scripts/dhcp-recursive-isp-3), до DHCP клієнтів в мікротіку (в данному прикладі розглядаєть підключеня 3-х провайдерів), необхідно вимкнути маршрути за замовчуванням. Скрипт автоматично додає та видаляє необхідні маршрути та правило маскарадинга.
